...
export default {
  ...
  daisyui: {
    themes: [
      ...
      {
        // Inspiré de Nextoo : bleu corporate clair + rouge en accent (un peu old school)
        nextoo: {
          primary: 'oklch(52% 0.18 250)',
          'primary-content': 'oklch(99% 0.005 240)',
          secondary: 'oklch(58% 0.22 25)',
          'secondary-content': 'oklch(99% 0.005 25)',
          accent: 'oklch(64% 0.15 250)',
          'accent-content': 'oklch(99% 0.005 240)',
          neutral: 'oklch(30% 0.04 250)',
          'neutral-content': 'oklch(98% 0.005 240)',
          'base-100': 'oklch(99% 0.003 240)',
          'base-200': 'oklch(95% 0.01 240)',
          'base-300': 'oklch(88% 0.018 240)',
          'base-content': 'oklch(22% 0.04 250)',
